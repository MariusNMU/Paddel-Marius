...
public final class ReglesMetier {
    ...
    public static final Duration PAUSE_ENTRE_MATCHES =
            Duration.ofMinutes(PAUSE_ENTRE_MATCHES_MINUTES);

    public static final BigDecimal PRIX_TOTAL_MATCH =
            new BigDecimal("60.00");

    public static final BigDecimal MONTANT_PARTICIPATION_STANDARD =
            new BigDecimal("15.00");

    public static final BigDecimal SOLDE_INITIAL_JOUEUR =
