-- ============================================================
-- Artefact de schéma SQL - Projet Padel Marius
-- Objectif : fournir une preuve claire du modèle relationnel.
-- Remarque : dans le MVP H2, les tables sont créées par JPA.
-- Ce fichier est un artefact de remise, pas le script exécuté
...
CREATE TABLE horaire_annuel_site (
                                     ...
                                     CONSTRAINT uk_horaire_site_annee UNIQUE (site_id, annee_civile),
